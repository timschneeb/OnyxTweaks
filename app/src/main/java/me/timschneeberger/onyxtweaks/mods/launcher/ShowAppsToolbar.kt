...
/**
 * This mod pack shows or hides the apps toolbar in the Onyx Launcher.
 *
 * When enabling the advanced desktop widget mode, the toolbar is hidden by default.
 * Large screen devices use the widget mode by default and as such, the toolbar is normally also hidden.
 */
