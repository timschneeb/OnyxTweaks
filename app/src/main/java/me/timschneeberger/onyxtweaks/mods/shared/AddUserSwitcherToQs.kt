...
/**
 * This mod pack adds a user switcher button to the quick settings panel header.
 *
 * It will try to show the user switcher dialog if available,
 * otherwise it will launch the user settings page.
 */
