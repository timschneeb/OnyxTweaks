...
This components works without Xposed. **You can even modify the system config at /onyxconfig without root access!** However, other config files stored in private app data require root access.
